    ...
    return (
        <div>
            <form onSubmit={(e) => handleSubmit(e)}>
                ...
                <input type="number" onChange={(e) => handlePrice(e)} name="price_product" placeholder="Introduce a Price..." />

                <label htmlFor="description_product">Description</label>
                <textarea onChange={(e) => handleTextArea(e)} name="description_product" placeholder="Introduce a description..." />

                <label htmlFor="image_product">Images</label>
                <input value={info.url} onChange={(e) => handleInfoChange(e)} name="image_product" placeholder="Add Images..." />
                <button onClick={(e) => handleImage(e)}>Add</button>

                <label htmlFor="thumbnail_product">Thumbnail</label>
                <input onChange={(e) => handleChange(e)} name="thumbnail_product" placeholder="Introduce a Thumbnail url" />

                <label htmlFor="in_stock">Stock</label>
                <select onChange={(e) => handleStock(e)} name="in_stock" placeholder="Select an Option">
